...
if __name__ == "__main__":
    ...
    plot_table(
        ...
        filename="Overall_data_no_first.png"
    )
    print(f"→ Saved: Overall_data_no_first.png")

    # ケース定義（first条件なし）
    cases = [
        ("All_ex1",   df,               "ex1"),
        ("Cond0_ex1", df[df["Cond"]==0], "ex1"),
        ("Cond1_ex1", df[df["Cond"]==1], "ex1"),
        ("All_ex2",   df,               "ex2"),
        ("Cond0_ex2", df[df["Cond"]==0], "ex2"),
        ("Cond1_ex2", df[df["Cond"]==1], "ex2"),
    ]
    ...
    for name, subdf, prefix in cases:
        ...
        plot_table(
            ...
            filename=f"{name}_no_first.png"
        )
        print(f"→ Saved: {name}_no_first.png")
